...
//
	...
	private void initialLoginPanelWithElements() {
		...
		//
		// Schritt 1
		// use Jmenubar and JMenu
		menubar = new JMenuBar();
		menubar.setBackground(Color.black);

		menu = new JMenu("Anwendungs -Menu");
		menu.setForeground(Color.white);
		// menu an menubar zuweisen
		menubar.add(menu);
		// jetzt brauchen wir items: also menuItems
		menuItemBeenden = new JMenuItem("Beenden");
		// Menuitem den Menu hinzufuegen
		menu.add(menuItemBeenden);
		// Menubar in Fenster hinzufuegen
		setJMenuBar(menubar);
		/////////////////////////////////////////
		// Schritt 2
		// siehe Bank.java
		// Listener fuer Menu programmieren
		pack();
	}
	...
	public void setMenuItemBeenden(JMenuItem menuItemBeenden) {
		this.menuItemBeenden = menuItemBeenden;
	}
